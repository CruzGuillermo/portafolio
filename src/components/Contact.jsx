            ...
            <section className="container mx-auto px-16 mb-5 mobile_padding" id="contact">
                ...
                <div className="flex justify-center mt-10 gap-11 mobile_padding">
                    <div className="contact_icons">
                        <a href="mailto:guillermobelizcruz98@gmail.com" aria-label="Email" target="_blank"><FontAwesomeIcon icon={faPaperPlane} /></a>
                        <span>{t("contact.email")}</span>
                    </div>
                    <div className="contact_icons">
                        <a href="https://www.linkedin.com/in/guillermo-cruzbeliz/" aria-label="LinkeIn" target="_blank"><FontAwesomeIcon icon={faLinkedin} /></a>
                        <span>{t("contact.linkedin")}</span>
                    </div>
                    <div className="contact_icons">
                        <a href="https://github.com/CruzGuillermo" aria-label="Github" target="_blank"><FontAwesomeIcon icon={faGithub} /></a>
